...
var instrucciones = ["Mover las piezas con las flechas de direccion", "Hay un espacio en blanco que permite el movimiento", "Una vez que el rompecabezas se vea como en la imagen objetivo el juego se termina"];
...
function addLastDirection(direccion) {
...
function intercambiarPosicionesGrilla(filaPos1, columnaPos1, filaPos2, columnaPos2) {
  var aux = [];
    aux = grilla[filaPos1][columnaPos1];
...
function moverEnDireccion(direccion) {
  ...
  las funciones posicionValida, intercambiarPosicionesGrilla y actualizarPosicionVacia */
    ...
    if (posicionValida(nuevaFilaPiezaVacia, nuevaColumnaPiezaVacia)) {
     ...
     var aux = [nuevaFilaPiezaVacia, nuevaColumnaPiezaVacia];
